...
% Objective-1: Write a program to plot signal constellation diagram of received % 8-PSK 
...
EbN0db = 10; % Change this value & run program to see the noisy constellation. 
